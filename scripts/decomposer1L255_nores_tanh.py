...
model_config_path = CONFIG_DIR / "models" / "decomposer" / "decomposer1L255_nores_tanh.yaml"
...
for song_name in ['Dua Lipa - Levitating Featuring DaBaby (Official Music Video).mp3', 'MB14 - Road to Zion.mp3', 'A_Classic_Education_-_NightOwl_-_0.aac']:
    ...
    for j in range(4):
        ...
        new_s.to_mp3(f'/home/martin/Music/decomposer/1L255_tanh_{song_name[:-4]}_{j}.mp3')
