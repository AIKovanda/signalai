...
data_config_path = CONFIG_DIR / "data_preparation" / "voice_splitter.yaml"
model_config_path = CONFIG_DIR / "models" / "voice_reducer" / "wide_inceptiontime_splitter.yaml"
...
for song_name in ['Dua Lipa - Levitating Featuring DaBaby (Official Music Video).mp3', 'MB14 - Road to Zion.mp3', 'A_Classic_Education_-_NightOwl_-_0.aac']:
    ...
    for j in range(2):
        ...
        new_s.to_mp3(f'/home/martin/Music/voice_splitter/{song_name[:-4]}_{j}.mp3')
